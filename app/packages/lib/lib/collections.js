 ...
 */
Meteor.Collection.prototype.addField = function (fieldOrFieldArray) {
 ...
 */
ShareBJ.allowCheck = function (collection, userId, document, fieldNames, modifier) {
...
Meteor.Collection.prototype.allowCheck = function (userId, document, fieldNames, modifier) {
  ShareBJ.allowCheck(this, userId, document, fieldNames, modifier);
};

/**
 * Global schemas object. Note: not reactive, won't be updated after initialization
 * @namespace ShareBJ.schemas
 */
ShareBJ.schemas = {};
